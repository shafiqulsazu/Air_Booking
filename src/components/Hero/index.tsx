        ...
        <div className="flex md:flex-row flex-col items-center w-full md:px-[200px] px-8 justify-between md:gap-0 gap-28">
            <div className="flex flex-col gap-3 left-animation w-full">
                ...
                <span className="text-white leading-7 max-w-[500px] text-justify">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit quae harum nisi deleniti neque dignissimos, vitae vel, iusto nulla, quod odit! Dolorum, dolores ipsa. Quod officia officiis quisquam facere deleniti.
                </span>
            ...
            <img src={plane} className="md:w-[53%] w-full right-animation" alt="" />
        </div>
