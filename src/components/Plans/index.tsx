  ...
  return (
    <div className='flex w-full pt-5 pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center'>
        <div className="flex flex-col w-full items-center">
            ...
            <p className='text-center max-w-[400px] mt-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
        </div>
        <div className="flex w-full items-center justify-center md:flex-row flex-col gap-8">
            {plansList.map((plan) => {
                return <div key={plan.title} className='bg-white p-[10px] rounded-[10px]' style={{boxShadow: "0 0 40px 5px rgb(0 0 0 /5%)"}}>
                    <img src={plan.image}
                    ...
                    <div className="text-slate-800 mt-10 font-medium px-4">
                        <span className='text-blue-500 font-semiboldtext-[25px]'>${plan.price}</span>{""}
                         / Hour
                    </div>
